...
const SmallUserAlbumCard = ({ url, title, secondaryText, imageSrc, altText, width, username, userDisplayName, userThumbnailUrl, userUrl}: any) => {
    return (
        <div>
...
export default SmallUserAlbumCard
